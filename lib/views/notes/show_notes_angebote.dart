...
class ShowNoteAngeboteView extends StatefulWidget {
  final String documentId;
  const ShowNoteAngeboteView({Key? key, required this.documentId}) : super(key: key);

  @override
  _ShowNoteAngeboteViewState createState() => _ShowNoteAngeboteViewState();
}

class _ShowNoteAngeboteViewState extends State<ShowNoteAngeboteView> {
